...
import xyz.rfsfernandes.tmdbdemo.presentation.ui.details.DetailsScreenViewModel
...
object DI {
    ...
    private val domainModule = module {
        ...
        single<GetMovieDetailsUseCase> { GetMovieDetailsUseCase(get<TmdbMediator>()) }
    }
